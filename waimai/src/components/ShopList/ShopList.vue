<template>
  <div class="shop_container">
    <ul v-if="shops.length" class="shop_list">
      <li class="shop_li border-1px" @click="$router.push('/shops')" v-for="(shop,index) in shops" :key="index">
        <a>
          <div class="shop_left">
    ...
    <ul v-else><li v-for="i in 8" :key="i"><img src="./images/shop_back.svg" alt=""></li></ul>
  </div>
</template>
